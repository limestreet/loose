...
//var $looseTopMenu = $('#top-navigation > div > ul');
var $looseMenuLogo = $('.home .menu-logo');
//var $looseMenuLogoWidth = $looseMenuLogo.width();
...
//$(function(){
      ...
      //}
       ...
       if (st > lastScrollTop){
           ...
           //console.log('scroll down');
               //if( $looseSliderContainer.length ) {
    ...
    //$looseMenuLogo.hide();
    //$looseTopMenu.css({'padding-right': ''});
       } else {
          // upscroll code
		...
		$looseMenuLogo.show();
		//console.log($looseMenuLogoWidth);
		//if( $looseSliderContainer.length ) {
		    //$looseSliderContainer.css({'padding-top': '56px'});
		//} //else {
		    //$looseContent.css({'padding-top': '106px'});
		//}

		//if( $looseTopMenu.is(':hidden') ) {
		    //$looseMenuLogo.css({'float': '', 'padding-right': ''});
		    //$looseTopMenu.css({'padding-right': ''});
		//} else {
		    //$looseMenuLogo.css({'float': 'left'});
		    //$looseTopMenu.css({'padding-right': $looseMenuLogoWidth + 54 + 'px'});
		//}
...
/*var looseWidth = $(window).width();
$(window).resize(function(){
   if($(this).width() !== looseWidth){
    if( $looseTopMenu.is(':hidden') ) {
        //$looseMenuLogo.css({'float': '', 'padding-right': ''});
        //$looseTopMenu.css({'padding-right': ''});
    } else {
...
//});
    ...
    //var $looseSubmenuPlusTop = $('#top-navigation ul ul .expand-submenu');
    ...
    /*$looseSubmenuPlusTop.click( function(){
        //$looseAllLeftUlMenus.hide();
        ...
        if( $current.hasClass('item-visible')) {
            ...
            console.log('is visible');
            $current.css({'left': ''}).removeClass('item-visible');
            //console.log($looseMenuPlus);
            //console.log($(this).parent().children('ul'));
        } else {
            console.log('is not visible');
            $current.css({'left': '100%'}).addClass('item-visible');
        }
    });
    */    
...
//console.log(loose.getTemplateDirectoryUri);
